...
* use ehrQL's `show` feature to test ehrQL code against your dummy tables
...
The ehrQL code that we'll look at in this tutorial is quite simple, however, it is assumed that you are not *completely* new to ehrQL. We would recommend following the [Introduction to ehrQL tutorial](../introduction-to-ehrql/index.md) to learn more
about ehrQL itself.

You can also find a tutorial for writing an OpenSAFELY study in our [Getting started][1] guide.
