...
you will need to add codes with an "X" appended to the three-character codes in your codelist for it to work correctly with both the 
`primary_diagnosis`, `secondary_diagnosis`, and `all_diagnoses` fields in the APCS dataset:
