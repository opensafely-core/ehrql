...
def test_ons_cis(select_all):
    results = select_all(
        ...
        ONS_CIS_New(
            ...
            hhsize=1,
            health_care_clean=1,
            patient_facing_clean=1,
            covid_think_havehad=1,
            covid_date=date(2020, 4, 1),
            covid_nhs_contact=1,
            covid_admitted=1,
            covid_test_swab=1,
            covid_test_swab_neg_last_date=date(2020, 5, 1),
            covid_test_swab_pos_first_date=date(2020, 4, 1),
            covid_test_swab_result=1,
            think_have_covid_sympt_now=1,
            result_mk=1,
            result_mk_date=date(2020, 4, 1),
            ctSgene_result=1,
            result_combined=1,
            long_covid_have_symptoms=1,
        ),
    )
    assert results == [
        {
            ...
            "rural_urban": 1,
            "household_size": "1",
            "is_work_in_healthcare_status": True,
            "work_in_patient_facing_healthcare_status": 1,
            "covid_think_had": True,
            "covid_date_first_symptoms": date(2020, 4, 1),
            "covid_contacted_nhs": True,
            "covid_was_admitted": True,
            "covid_was_swab_tested": True,
            "covid_date_last_negative_swab_test": date(2020, 5, 1),
            "covid_date_first_positive_swab_test": date(2020, 4, 1),
            "covid_swab_test_result": "One or more positive tests",
            "covid_think_have_symptoms_now": True,
            "swab_test_result": "Positive",
            "swab_test_date": date(2020, 4, 1),
            "ct_sgene_result": "Positive",
            "combined_antibody_test_result": "Positive",
            "long_covid_have_had_symptoms": True,
        },
    ]
