...
def test_isaric_raw(select_all):
    results = select_all(
        ...
        ISARIC_New(
            ...
            ethnic___9=None,
            ethnic___10=None,
            covid19_vaccine=None,
            covid19_vaccined="2021-02-01",
            covid19_vaccine2d="2021-04-01",
            covid19_vaccined_nk=None,
            corona_ieorres=None,
            coriona_ieorres2=None,
            coriona_ieorres3=None,
            inflammatory_mss=None,
            cestdat="2022-01-01",
            chrincard=None,
            hypertension_mhyn=None,
            chronicpul_mhyn=None,
            asthma_mhyn=None,
            renal_mhyn=None,
            mildliver=None,
            modliv=None,
            chronicneu_mhyn=None,
            malignantneo_mhyn=None,
            chronichaemo_mhyn=None,
            aidshiv_mhyn=None,
            obesity_mhyn=None,
            diabetes_type_mhyn=None,
            diabetescom_mhyn=None,
            diabetes_mhyn=None,
            rheumatologic_mhyn=None,
            dementia_mhyn=None,
            malnutrition_mhyn=None,
            smoking_mhyn=None,
            hostdat="2022-01-07",
            hooccur=None,
            hostdat_transfer="2022-01-10",
            hostdat_transfernk=None,
            readm_cov19=None,
            dsstdat="2022-01-05",
            dsstdtc="2022-01-20",
        ),
    ...
    assert results == [
        ...
        },
        {
            ...
            "ethnic___10": None,
            "covid19_vaccine": None,
            "covid19_vaccined": None,
            "covid19_vaccine2d": None,
            "covid19_vaccined_nk": None,
            "corona_ieorres": None,
            "coriona_ieorres2": None,
            "coriona_ieorres3": None,
