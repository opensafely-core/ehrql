...
The `Backend` class provides a [`modify_dataset()`](https://github.com/opensafely-core/ehrql/blob/6e4430426fb31e41a4c95f264628dd89fee6a266/ehrql/backends/base.py#L26-L30) hook which allows the backend to add additional restrictions to the user's query to control what data it returns. Any changes to the query processing workflow **must ensure that this hook continues to be called**. This is currently enforced by integration tests ([tpp](https://github.com/opensafely-core/ehrql/blob/6e4430426fb31e41a4c95f264628dd89fee6a266/tests/integration/backends/test_tpp.py#L3142-L3163), [emisv2](https://github.com/opensafely-core/ehrql/blob/54175cb0ef7dd2d96a7af0f4450f7e7b3a341b24/tests/integration/backends/test_emisv2.py#L265-L298)) which ensures that the [`TPPBackend.modify_dataset()`](https://github.com/opensafely-core/ehrql/blob/6e4430426fb31e41a4c95f264628dd89fee6a266/ehrql/backends/tpp.py#L97) and [`EMISV2Backend.modify_dataset()`](https://github.com/opensafely-core/ehrql/blob/54175cb0ef7dd2d96a7af0f4450f7e7b3a341b24/ehrql/backends/emisv2.py#L46) hooks continue to behave as expected.
