...
class apcs(EventFrame):
    ...
    primary_diagnosis = Series(
        ...
        description=(
            ...
            "The primary diagnosis of a spell is determined during post-hoc processing "
            "of data for financial purposes. In most cases it is the main diagnosis "
            "associated with the most costly element of care received during a hospital "
            "provider spell."
        ),
    )
    secondary_diagnosis = Series(
        ...
        description=(
            ...
            "We do not recommend using this variable as its relationship to the order "
            "of diagnoses is unknown. All secondary diagnoses are available, along with "
            "the primary diagnosis, in the all_diagnoses field below."
        ),
    )
