...
class TrinoQueryEngine(BaseSQLQueryEngine):
    ...
    def _is_table_not_found_error(exception):
        ...
        # temporary table is not yet visible when a query tries to use it.
        ...
        # We observed that these errors originate as TrinoUserErrors which then get
        # wrapped into SQLAlchemy ProgrammingErrors - but we check the underlying error
